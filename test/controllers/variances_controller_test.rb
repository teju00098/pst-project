...
class VariancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variance" do
    assert_difference('Variance.count') do
      post variances_url, params: { variance: { BARCODE: @variance.BARCODE, LOCATION: @variance.LOCATION, QUANTITY: @variance.QUANTITY } }
    end
  ...
  test "should update variance" do
    patch variance_url(@variance), params: { variance: { BARCODE: @variance.BARCODE, LOCATION: @variance.LOCATION, QUANTITY: @variance.QUANTITY } }
